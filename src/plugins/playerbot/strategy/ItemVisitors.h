...
namespace ai
{
    ...
    public:
        ...
        virtual bool Visit(Item* item)
        {
            ...
            if (proto && std::strlen(proto->GetName(LOCALE_enUS)) > 0 && strstri(proto->GetName(LOCALE_enUS), name.c_str()))
                count += item->GetCount();
    ...
    public:
        ...
        {
            return proto && std::strlen(proto->GetName(LOCALE_enUS)) > 0 && strstri(proto->GetName(LOCALE_enUS), name.c_str());
        }
