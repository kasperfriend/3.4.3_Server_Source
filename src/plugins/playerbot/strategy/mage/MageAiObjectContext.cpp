...
#include "strategy/mage/FrostMageStrategy.h"
#include "strategy/mage/ArcaneMageStrategy.h"
#include "strategy/mage/GenericMageNonCombatStrategy.h"
#include "strategy/mage/FireMageStrategy.h"
